(function() {
    ...
    function Va(a, b) {
        ...
        c ? c(a, b, void 0, void 0, void 0) : (c = [],
        c = "ERRORS"in R ? R.ERRORS : c,
    ...
    function S(a) {
        ...
        try {
            ...
            a = {};
            if (("EXPERIMENT_FLAGS"in R ? R.EXPERIMENT_FLAGS : a).kevlar_js_fixes)
                return;
            throw c;
        }
        for (var b in a)
    ...
    function Za(a, b, c, d) {
        ...
        return ma(function(e) {
            var f = "boolean" == typeof e[4] && e[4] == !!d, g;
            if (g = t(e[4]) && t(d))
                a: {
                    g = e[4];
                    for (var h in g)
    ...
    function bb(a, b, c) {
        ...
        if (a && (a.addEventListener || a.attachEvent)) {
            ...
            if (!e) {
                ...
                ab() || "boolean" == typeof d ? a.addEventListener(b, g, d) : a.addEventListener(b, g, !!d.capture)) : a.attachEvent("on" + b, g);
                A[e] = [a, b, c, g, d]
            }
        }
    }
    ...
    function X(a, b, c) {
        ...
        if (a = m(a) ? c.getElementById(a) : a)
            ...
            b.host || (b.host = c ? Pa(a.src) : "https://www.youtube.com"),
            this.b = new kb(b),
            c || (b = mb(this, a),
            this.i = a,
    ...
    k.destroy = function() {
        ...
        if (this.i) {
            ...
            (a = this.a) && a.parentNode && a.parentNode.removeChild(a);
        V && (V[this.h] = null);
        this.b = null;
        a = this.a;
        for (var c in A)
    ...
    k.getVideoEmbedCode = function() {
        ...
        wa.test(c) && (-1 != c.indexOf("&") && (c = c.replace(qa, "&amp;")),
        -1 != c.indexOf("<") && (c = c.replace(ra, "&lt;")),
        -1 != c.indexOf(">") && (c = c.replace(sa, "&gt;")),
        -1 != c.indexOf('"') && (c = c.replace(ta, "&quot;")),
        -1 != c.indexOf("'") && (c = c.replace(ua, "&#39;")),
        -1 != c.indexOf("\x00") && (c = c.replace(va, "&#0;")));
